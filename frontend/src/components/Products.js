...
const Products = () => {
    ...
    return (
        <div className="background">
                    ...
                    <div className="filter-popup">
                        <div className="popup-content">
                            ...
                            <div className="filter-category">
                                <h4 onClick={() => toggleOptions('category-options')}>Category</h4>
                                <div className="filter-options" style={{ display: expandedOption === 'category-options' ? 'block' : 'none' }}>
                                    ...
                                    <label><input type="checkbox" name="category" value="hearty-sandwiches" /> Hearty Sandwiches</label>
                                        ...
                                        {/* Flavour Filters */}
            <div className="filter-category">
                <h4 onClick={() => toggleOptions('flavour-options')}>Flavour</h4>
            ...
            <div className="filter-category">
                <h4 onClick={() => toggleOptions('dietary-options')}>Dietary Restrictions</h4>
            ...
            {/* Occasion Filters */}
            <div className="filter-category">
                <h4 onClick={() => toggleOptions('occasion-options')}>Occasion</h4>
