        ...
        public static void SeedProductsAndCategories(IServiceProvider serviceProvider)
        {
            ...
            // Create product instances
                var sourdoughBread = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "vegan", "breakfast", "nut-free", "sugar-free", "classic-breads" },
                ...
                var cinnamonBun = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "spiced", "fika", "lucia", "nut-free", "grandmas-pastries" },
                ...
                var almondTwist = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "nutty", "fika", "breakfast", "grandmas-pastries" },
                    Categories = new List<CategoryModel> { categories[1] },  // Grandma’s Pastries
                ...
                var chocolateCroissant = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "chocolate", "breakfast", "fika", "nut-free", "grandmas-pastries" },
                    Categories = new List<CategoryModel> { categories[1] },  // Grandma’s Pastries
                ...
                var veganBrownie = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "vegan", "chocolate", "dairy-free", "nut-free", "fika", "grandmas-pastries" },
                ...
                var glutenFreeMuffin = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "gluten-free", "nut-free", "fika", "breakfast", "grandmas-pastries" },
                    Categories = new List<CategoryModel> { categories[1] },
                ...
                var layerCake = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "chocolate", "vanilla", "nut-free", "birthday", "wedding", "homemade-cakes" },
                ...
                var redVelvetCake = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "chocolate", "nut-free", "birthday", "wedding", "homemade-cakes" },
                    Categories = new List<CategoryModel> { categories[2] },  // Homemade Cakes
                ...
                var homebrewedCoffee = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "breakfast", "fika", "warm-drinks-coffee" },
                ...
                var hotChocolate = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "chocolate", "fika", "breakfast", "warm-drinks-coffee" },
                    Categories = new List<CategoryModel> { categories[3] },  // Warm Drinks & Coffee
                ...
                var hamAndCheeseSandwich = new ProductModel
                {
                    ...
                    FilterTags = new List<string> { "breakfast", "nut-free", "sugar-free", "hearty-sandwiches" },
